...
|------|----------|----------|------|
| release 零样本 | **27.58** | 105.0 | 12 个片段全部不同（含拐杖/伤腿/负重等病理步态）；新死因 wrist_yaw_h 3/12 |
| ref PD | **36.42** | 198.9 | **PD 反超 release 32%** |

**旧数字（32.9/35.25/26.67）正式退役。** 多样化片段上训练策略显著不如手写跟踪器——技能压缩的强信号（2 片段时打平，500 片段时倒挂 32%）。
